...
* Die Usertests müssen den vollständigen Prozess des INHALT einschließlich – und falls für die Implementierung erforderlich – dem Zusammenspiel mit mehreren Endgeräten oder Apps.
