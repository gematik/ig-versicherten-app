...
* Eine Rechnung ist in der Uebersicht sichtbar.
| Ausloeser/Trigger | Der Versicherte waehlt in link:rechnungen-anzeigen.adoc[UC_RECHNUNGEN_ANZEIGEN] eine Rechnung aus.
| Hauptablauf
