...
|===
| Use Case | MockUp | Beschreibung | Empfehlung zur Umsetzung | weitere Quellen
...
| Sortier-/Filterfunktion
| image:../images/Filter.svg[Filter für Rechnungen, width=140, link=../images/Filter.svg]
| Rechnungsliste sortieren/filtern
 a| Mindestens sortieren nach:

* Rechnungsdatum
* Zahlungszieldatum
* Gesamtbetrag

Mindestens filtern nach:
...
| image:../images/Zahlungsunterstuetzung.svg[Zahlungsunterstuetzung, width=140, link=../images/Zahlungsunterstuetzung.svg]
...
| Markierungen
| image:../images/Persoenlich.svg[Markierung Persoenlich, width=140, link=../images/Persoenlich.svg]
...
| Markierungen können gesetzt und zusätzlich eine Notiz hinterlegt werden.
  ...
  * Bezahlt
  * Gelesen
  * Eingereicht (per Frontend / per Post)
  * Geteilt
  * Archiviert
...
| image:../images/gelöscht.svg[Markierung Löschung, width=140, link=../images/gelöscht.svg]
| Erinnerung, dass der Fachdienst eine Rechnung in den Papierkorb verschoben hat und diese in n-Wochen gelöscht wird
a| Wichtige Infos für die Push Nachricht:
...
| -
| Versicherten-Einstellungen im Konto anpassen
 a|
* Der Versicherte kann Einstellungen seines Kontos anpassen, z. B.:
...
| -
| Geänderten Namen aus der GesundheitsID ins Versichertenkonto übernehmen
 a|
...
| Nutzerkonto löschen
| -
| Versicherter löscht selbst sein Versichertenkonto
 a|
* Der Versicherte kann sein Versichertenkonto im FdV eigenständig löschen.
