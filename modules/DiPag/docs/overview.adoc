...
* Hinweis: Bei einer One-App-Strategie braucht es keinen Appwechsel, sondern nur eine Abfrage der GesundheitsID. Die vorhandenen Abfragen bleiben jedoch bestehen.
