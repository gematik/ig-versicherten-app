...
| Anmelden an der App (Online Fall)
| -
| Anmeldung bei bestehender Internetverbindung
 a|
* TODO
| link:

| Anmelden an der App (Offline-Fall)
| -
| Anmeldung ohne bestehende Internetverbindung
 a|
* Bereits heruntergeladene Rechnungen können im Vorfeld gespeichert werden und angezeigt werden
...
| link:rechnungen-anzeigen.adoc[UC_RECHNUNGEN_ANZEIGEN]
| image:../images/Rechnung.svg[Rechnungsansicht, width=140, link=../images/Rechnung.svg]
...
| Filterfunktion
| image:../images/Filter.svg[Filterfunktion, width=140, link=../images/Filter.svg]
...
| image:../images/Auswahl.svg[Auswahl, width=140, link=../images/Auswahl.svg]
...
| link:detail-ansicht.adoc[UC_DETAIL_ANSICHT]
 a|
image:../images/Detail.svg[Detailansicht, width=140, link=../images/Detail.svg]

image:../images/Detail-1.svg[Detailansicht erweitert, width=140, link=../images/Detail-1.svg]
...
| Rechnung teilen
| image:../images/Teilen.svg[Teilen, width=140, link=../images/Teilen.svg]
...
| image:../images/Push.svg[Push, width=140, link=../images/Push.svg]
